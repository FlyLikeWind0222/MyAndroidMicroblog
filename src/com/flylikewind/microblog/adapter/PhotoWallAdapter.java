...
import com.flylikewind.microblog.bean.DiskLruCache;
import com.flylikewind.microblog.bean.DiskLruCache.Snapshot;
	...
	public View getView(int position, View convertView, ViewGroup parent) {
		...
		if (convertView == null) {
			view = LayoutInflater.from(getContext()).inflate(
					R.layout.image_gridview_item, null);
		} else {
			view = convertView;
		}
		final ImageView imageView = (ImageView) view
				.findViewById(R.id.image_gridview_item_imageview);
