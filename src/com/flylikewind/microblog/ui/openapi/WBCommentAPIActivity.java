...
/**
 * 该类主要演示了如何使用微博 OpenAPI 来获取以下内容： <li>获取某条微博的评论列表 <li>...
 * 
 * @author SINA
 * @since 2013-11-24
 */
public class WBCommentAPIActivity extends Activity implements
		OnItemClickListener {
	...
	public void onItemClick(AdapterView<?> parent, View view, int position,
		...
		if (view instanceof TextView) {
			if (mAccessToken != null && mAccessToken.isSessionValid()) {
				switch (position) {
				case 0:
					mCommentsAPI.toME(0L, 0L, 10, 1,
							CommentsAPI.AUTHOR_FILTER_ALL,
							CommentsAPI.SRC_FILTER_ALL, mListener);
					break;

				case 1:
					mCommentsAPI.byME(0L, 0L, 10, 1,
							CommentsAPI.SRC_FILTER_ALL, mListener);
					break;
