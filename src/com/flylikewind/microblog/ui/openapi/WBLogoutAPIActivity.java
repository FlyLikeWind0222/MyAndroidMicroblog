...
/**
 * 该类主要演示了如何使用 {@link LogoutAPI} 来注销登陆。 当注销后，您的已有 Token 将不能再次被使用。
 * 
 * @author SINA
 * @since 2013-11-05
 */
public class WBLogoutAPIActivity extends Activity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		if (mAccessToken != null && mAccessToken.isSessionValid()) {
			...
			mTokenView.setText(String.format(format, mAccessToken.getToken(),
					date));
		}
		...
		mLogoutButton.setOnClickListener(new OnClickListener() {
			...
			public void onClick(View v) {
				if (mAccessToken != null && mAccessToken.isSessionValid()) {
					new LogoutAPI(WBLogoutAPIActivity.this, Constants.APP_KEY,
