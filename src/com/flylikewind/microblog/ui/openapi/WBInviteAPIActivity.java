...
public class WBInviteAPIActivity extends Activity implements OnClickListener {
	...
	public void onClick(View v) {
		...
		if (accessToken != null && accessToken.isSessionValid()) {
			// 调用 OpenAPI 接口发送邀请
			new InviteAPI(this, Constants.APP_KEY, accessToken).sendInvite(uid,
					jsonObject, mInviteRequestListener);
		} else {
			Toast.makeText(WBInviteAPIActivity.this,
	...
	private void showToast(boolean bSuccess, String message) {
		int resId = bSuccess ? R.string.weibosdk_demo_openapi_invite_success
