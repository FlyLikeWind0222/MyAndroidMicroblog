...
package com.flylikewind.microblog.ui.openapi;
...
/**
 * 该类主要演示了如何使用微博 OpenAPI 来获取以下内容： <li>获取最新的公共微博 <li>获取当前登录用户及其所关注用户的最新微博 <li>
 * 获取当前登录用户及其所关注用户的最新微博的ID <li>...
 * 
 * @author SINA
 * @since 2013-11-24
 */
public class WBStatusAPIActivity extends Activity implements
		OnItemClickListener {
	...
	public void onItemClick(AdapterView<?> parent, View view, int position,
		...
		if (view instanceof TextView) {
			if (mAccessToken != null && mAccessToken.isSessionValid()) {
				...
				case 1:
					mStatusesAPI.mentions(0L, 0L, 10, 1, 0, 0, 0, false,
							mListener);
					break;
				...
				case 3:
					...
					mStatusesAPI.upload("发送一条带本地图片的微博", bitmap, null, null,
							mListener);
					 ...
					 * wbparams.put("visible", "0"); wbparams.put("list_id",
					 * ""); wbparams.put("pic", bitmap); wbparams.put("lat",
					 * "14.5"); wbparams.put("long", "23.0");
					 * wbparams.put("annotations", "");
					 * 
					 * AsyncWeiboRunner.requestAsync(
					 * "https://api.weibo.com/2/statuses/upload.json", wbparams,
					 * "POST", mListener);
					 */
					break;
				...
				case 4:
					...
					mStatusesAPI.uploadUrlText("发送一条带网络图片的微博", photoURL, null,
							null, null, mListener);
					break;
	...
	private RequestListener mListener = new RequestListener() {
		...
		public void onWeiboException(WeiboException e) {
			...
			Toast.makeText(WBStatusAPIActivity.this, info.toString(),
					Toast.LENGTH_LONG).show();
		}
	};
}
