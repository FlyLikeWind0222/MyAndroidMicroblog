...
public class WBPayActivity extends Activity implements IWeiboHandler.Response {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		findViewById(R.id.weibo_get_order).setOnClickListener(
				new View.OnClickListener() {
					@Override
					public void onClick(View v) {
						GetOrderTask task = new GetOrderTask(orderUri.getText()
								.toString());
						task.execute();
					}
				});

		findViewById(R.id.weibo_pay).setOnClickListener(
				new View.OnClickListener() {
					@Override
					public void onClick(View v) {
						if (isSupportPay) {
		...
		((TextView) findViewById(R.id.weibosdk_demo_support_weibo_pay))
				.setText(isSupportPay ? "true" : "false");
	}
