 ...
 * 
 * <b>请注意：</b>基于以下几点原因，您可能不想使用前面的两种授权方式： <li>出于安全性的考虑，您不信任目前使用应用的包名和签名来获取 Token
 * 的方式</li> <li>您不想安装微博客户端</li></br> 您可以自行通过 Code 来获取 Token。通过这种方式需要使用到
 * APP_SECRET，请务必妥善保管好 自己的 APP_SECRET，<b>泄露有风险</b>。 更多细节请查看：</b><a
 * href="http://t.cn/zldm9tt">验证授权步骤</a>
 * 
 * @author SINA
 * @since 2013-10-18
 */
...
public class WBAuthCodeActivity extends Activity {
	 ...
	 */
	private static final String WEIBO_DEMO_APP_SECRET = "8a38c08f5236734185cee8b2c14c9f99";//4e47e691a516afad0fc490e05ff70ee5
	...
	public void fetchTokenAsync(String authCode, String appSecret) {
		...
		// 异步请求，获取 Token
		new AsyncWeiboRunner(getApplicationContext()).requestAsync(
				OAUTH2_ACCESS_TOKEN_URL, requestParams, "POST",
				new RequestListener() {
					@Override
					public void onComplete(String response) {
						...
						if (token != null && token.isSessionValid()) {
							...
							mTokenText.setText(String.format(format,
