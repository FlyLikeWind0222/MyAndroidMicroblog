...
/**
 * 该类主要演示了如何使用登录/注销控件。 目前，我们提供了两类登录控件： <li>单独的登陆控件，只提供登录功能，它有三种样式 <li>
 * 登录/注销组合控件，提供内置的登录和注销功能，它有两种样式
 * 
 * @author SINA
 * @since 2013-09-29
 */
public class WBLoginLogoutActivity extends Activity {
		...
		logoutButton.setOnClickListener(new OnClickListener() {
			...
			public void onClick(View v) {
				new LogoutAPI(WBLoginLogoutActivity.this, Constants.APP_KEY,
						AccessTokenKeeper
								.readAccessToken(WBLoginLogoutActivity.this))
	...
	private class AuthListener implements WeiboAuthListener {
		...
		public void onWeiboException(WeiboException e) {
			Toast.makeText(WBLoginLogoutActivity.this, e.getMessage(),
