...
public class WBSocialActivity extends Activity {
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		mAttentionView.setAttentionParam(AttentionComponentView.RequestParam
				.createRequestParam(Constants.APP_KEY, mAccessToken.getToken(),
						"2016183205", "", new WeiboAuthListener() {
							@Override
		...
		mCommentView.setCommentParam(CommentComponentView.RequestParam
				.createRequestParam(Constants.APP_KEY, mAccessToken.getToken(),
						"后会无期", "测试评论", CommentComponentView.Category.MOVIE,
