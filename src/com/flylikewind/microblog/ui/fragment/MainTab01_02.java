...
@SuppressLint("NewApi")
public class MainTab01_02 extends Fragment implements IXListViewListener {

	public int pageCount = 50;
	private XListView tabHomeListview;
	private HomeListviewAdapter2 adapter;
	private ImageView radar;
	private static MainTab01_02 mTab01;
	...
	public static MainTab01_02 getInstance() {
		if (mTab01 == null) {
			synchronized (MainTab01_02.class) {
				if (mTab01 == null) {
					mTab01 = new MainTab01_02();
				}
			}
		}
		return mTab01;
